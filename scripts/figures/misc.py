...
import pandas as pd
df = pd.read_json("/home/suching/neural_persona/logs/hatespeech_classifier_search/results.jsonl", lines=True)
df1 = pd.read_json("/home/suching/neural_persona/logs/vampire_hatespeech_search/results.jsonl", lines=True)
